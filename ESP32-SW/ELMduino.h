...
public:
	...
	bool timeout();
	float rpm();
  float tanklevel();  // added into original file: https://github.com/PowerBroker2/ELMduino
  float Km_scc();     // added into original file: https://github.com/PowerBroker2/ELMduino  
	int32_t kph();
	float mph();
